  ...
  <div>
    <nav class="flex items-center justify-between px-6 md:px-24 py-6 bg-white shadow-md border-b border-blue-200">
      ...
      <div class="flex items-center space-x-6">
        ...
        <NuxtLink to="/articles/create" class="flex items-center text-lg text-black">
          ✏️ เขียนบทความ
        </NuxtLink>
        ...
        <template v-else>
          ...
          <transition name="fade">
            <div v-show="showDropdown"
              ...
              <NuxtLink to="/profile" class="block px-4 py-3 text-gray-700 hover:bg-gray-100 transition">
                👤 โปรไฟล์
              </NuxtLink>
              <NuxtLink to="/articles/my-articles" class="block px-4 py-3 text-gray-700 hover:bg-gray-100 transition">
                📚 จัดการบทความ
              </NuxtLink>
